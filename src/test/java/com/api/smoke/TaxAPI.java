...
public class TaxAPI {
    ...
    public void TaxSetup() throws Exception{
        ...
        SmartResponse response= groupCreate.GroupCreate(null, config.createGroup(),"Duties & Taxes", "duties_&_taxes", "currentliabilities");
    ...
    public void addTax() throws  Exception{
         ...
         */
        SmartResponse resp = methodManager.postAPI_with_Assert_Statuscode(null,config.createTax(), body);
